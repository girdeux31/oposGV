...
class Subject:
    ...
    def __str__(self):
        ...
        output += 'TRIBUNAL\n'
        output += 'ID: tribunal ID (A for Alicante, V for Valencia and C for Castellon)\n'
        output += 'Students: number of total candidates\n'
        output += '\n'
        output += 'PART 1\n'
        output += 'Theory Avg Marks: average mark for theory exam over all non-absent students / over all students that got a pass in part 1\n'
        output += 'Practice Avg Marks: average mark for practice exam over all non-absent students / over all students that got a pass in part 1\n'
        ...
        output += '\n'
        output += 'PART 2\n'
        output += 'Teaching Avg Marks: average mark for teaching exam over all students that got a pass in part 2\n'
        output += 'Passed: number of total candidates that got a passed in part 2, absolute / relative to all students in part 1\n'
        output += '\n'
        output += 'TOTAL\n'
        output += 'Avg Marks: average total mark for the three exams over all students that got a pass in part 2\n'
        output += '\n'
        output += 'PART 3\n'
